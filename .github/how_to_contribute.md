...
2. Once all open comments and all checklist items are resolved, your contributions will be merged! The merged PR will be
   included in the next release. The terraform-huaweicloud-eip maintainers are responsible for updating the CHANGELOG when they
   merge.
...
- [ ] README.md has been updated after any changes to variables and outputs. See https://github.com/terraform-huaweicloud-modules/terraform-huaweicloud-eip/#doc-generation
